...
const footerLinks = [
  {
    title: "Products",
    links: [
      { name: "CyberSleuth Web", href: "#" },
      { name: "API Protection", href: "#" },
      { name: "CI/CD Integration", href: "#" },
      { name: "CLI Tool", href: "#" },
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
          <div className="col-span-2">
            ...
            <p className="mt-4 text-gray-400">
              The intelligent cybersecurity copilot that detects and helps fix vulnerabilities before hackers find them.
            </p>
            ...
            <div key={group.title}>
              ...
              <ul className="mt-4 space-y-2">
                {group.links.map((link) => (
                  <li key={link.name}>
                    <a href={link.href} className="text-sm text-gray-400 hover:text-cyan-400">
                      {link.name}
                    </a>
                  </li>
                ))}
        ...
        <div className="mt-12 pt-8 border-t border-slate-800">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm text-gray-400">
              &copy; {new Date().getFullYear()} CyberSleuth AI. All rights reserved.
            </p>
            
            <div className="flex space-x-6 mt-4 md:mt-0">
              <a href="#" className="text-sm text-gray-400 hover:text-cyan-400">Privacy</a>
              <a href="#" className="text-sm text-gray-400 hover:text-cyan-400">Terms</a>
              <a href="#" className="text-sm text-gray-400 hover:text-cyan-400">Cookies</a>
              <a href="#" className="text-sm text-gray-400 hover:text-cyan-400">Contact</a>
            </div>
          </div>
        </div>
      </div>
